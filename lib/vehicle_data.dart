import 'vehicle.dart'; // 記得引入你的 model
...
final List<Vehicle> mockVehicles = const [
  ...
  Vehicle(
    ...
    media: VehicleMedia(
      ...
      hasSound: true,
      soundFilePath:
          'assets/brands/Audi/RS6 Avant/sound/RS6_sound.mp3',
    ),
    rating: VehicleRating(
      ratingTitle1: '外觀',
      rating1: 5,
  ...
  Vehicle(
    ...
    media: VehicleMedia(
      ...
      hasSound: true,
      soundFilePath:
          'assets/brands/Nissan/R34/sound/r34.mp3',
    ),
    rating: VehicleRating(
      ratingTitle1: '外觀',
      rating1: 5,
  ...
  Vehicle(
    ...
    media: VehicleMedia(
      ...
      hasSound: true,
      soundFilePath:
          'assets/brands/Toyota/GR Yaris/sound/gr_yaris.mp3',
    ),
    rating: VehicleRating(
      ratingTitle1: '外觀',
      rating1: 3,
  ...
  Vehicle(
    ...
    media: VehicleMedia(
      ...
      hasSound: true,
      soundFilePath:
        'assets/brands/Toyota/GR GT/sound/GR_GT.mp3',
    ),
    rating: VehicleRating(
      ratingTitle1: '外觀',
      rating1: 5,
  ...
  Vehicle(
    ...
    media: VehicleMedia(
      ...
      hasSound: true,
      soundFilePath:
          'assets/brands/Ford/Mustang/sound/Mustang GTD Sounds.mp3',
    ),
    rating: VehicleRating(
      ratingTitle1: '外觀',
      rating1: 4,
  ...
  Vehicle(
    ...
    media: VehicleMedia(
      ...
      hasSound: true,
      soundFilePath:
          'assets/brands/Mazda/Miata NA/sound/Mazda Miata NA.mp3',
    ),
    rating: VehicleRating(
      ratingTitle1: '可愛度',
      rating1: 5,
